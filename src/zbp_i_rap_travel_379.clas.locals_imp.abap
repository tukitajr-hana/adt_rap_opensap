...
* as the code can cope with active as well as with draft instances.
  ...
  METHOD is_create_granted.
    ...
    AUTHORITY-CHECK OBJECT 'ZZSTAT379'
      ID 'ZZSTAT379' DUMMY
      ID 'ACTVT' FIELD '01'.
  ...
  METHOD is_delete_granted.
    ...
    IF has_before_image = abap_true.
      AUTHORITY-CHECK OBJECT 'ZZSTAT379'
        ID 'ZZSTAT379' FIELD overall_status
        ID 'ACTVT' FIELD '06'.
    ELSE.
      AUTHORITY-CHECK OBJECT 'ZZSTAT379'
        ID 'ZZSTAT379' DUMMY
      ...
      IF is_update_requested = abap_true.
        ...
        IF has_before_image = abap_true.
          ...
          IF update_granted = abap_false.
            APPEND VALUE #( %tky        = travel-%tky
                            %msg        = NEW zrap_cl_msgtravel_379( severity = if_abap_behv_message=>severity-error
                                                                     textid   = zrap_cl_msgtravel_379=>unauthorized )
                          ) TO reported-travel.
          ENDIF.
